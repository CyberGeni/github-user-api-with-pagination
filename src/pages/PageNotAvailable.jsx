...
function PageNotAvailable() {
    return (
      <div className="bg-[#141c2f] text-slate-300 font-['Space_Grotesk'] h-screen flex flex-col items-center justify-center text-center">
        ...
        <p className="w-4/5 max-w-lg my-5">
          This page never existed, I don't even know how you found it. Before
          you say we don dey carry you dey go where you no know, go home. Abeg.
        </p>
